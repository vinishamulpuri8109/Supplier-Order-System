...
const ORDER_FIELD_MAP = {
  'Order ID': ['CustOrderNumber', 'po', 'order_number'],
  'Subtotal': ['Subtotal', 'subtotal'],
  'Tax': ['TaxAmount', 'tax_amount'],
  'Shipping': ['ShippingCharge', 'shipping_charge'],
  'Grand Total': ['TotalAmount', 'total_amount'],
  'Vendor Order Status': ['vendor_filled_display', 'vendor_status'],
};
